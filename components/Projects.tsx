...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      tech: ['React.js', 'Node.js', 'Supabase', 'Real-time Updates'],
      icon: ShoppingCart,
    ...
    },
    {
      ...
      tech: ['JavaScript', 'HTML', 'CSS', 'Interactive UI/UX'],
      icon: Gamepad2,
    ...
    },
    {
      ...
      category: 'AI • EdTech',
      tech: ['AI/ML', 'Full Stack', 'Computer Vision', 'Educational Technology'],
      icon: GraduationCap,
    ...
    },
    {
      ...
      tech: ['Tensorflow', 'NLP', 'Deep Learning', 'Cybersecurity'],
      icon: Shield,
